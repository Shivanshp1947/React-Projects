...
export default function Testimonials(props) {
  ...
  return (
    ...
    items-center mt-10 transition-all duration-700 p-10 hover:shadow-xl rounded-md'>
        ...
        <div className='mt-6'>
            ...
            transition-all duration-200 cursor-pointer px-10 py-2 rounded-md font-bold 
            text-white text-xl'>
                Surprise Me
            </button>
        </div>
